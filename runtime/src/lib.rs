...
parameter_types! {
	...
	pub const TransactionPrio: u32 = 1;
}
...
impl dkg_offchain_worker::Config for Runtime {
	...
	type Call = Call;
	type Event = Event;
	type GracePeriod = GracePer;
	type UnsignedInterval = UnsignedInt;
	type UnsignedPriority = TransactionPrio;
}
